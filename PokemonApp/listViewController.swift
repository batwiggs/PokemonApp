...
class listViewController: UIViewController {
    ...
    //var creatures = ["Bulbasaur","Pikachu","Snorlax"]
    ...
    override func viewDidLoad() {
        ...
        creatures.getData {
            DispatchQueue.main.async {
                self.navigationItem.title = "\(self.creatures.creatureArray.count) of \(self.creatures.count) loaded"
    ...
    func loadAll() {
        if creatures.urlString.hasPrefix("http") {
            ...
            DispatchQueue.main.async {
                print("All \(self.creatures.creatureArray.count) creatures loaded.")
                self.activityIndicator.stopAnimating()
                self.view.isUserInteractionEnabled = true
